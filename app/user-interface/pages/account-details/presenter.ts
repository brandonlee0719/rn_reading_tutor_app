...
export interface AccountDetailsView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class AccountDetailsPresenter extends BasePresenter implements UsersInteractorOutput {

    view: AccountDetailsView
    private interactor: UsersInteractor

    constructor(outputView: AccountDetailsView) {
        super(outputView)
