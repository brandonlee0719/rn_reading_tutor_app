...
export interface AddLearnerView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class AddLearnerPresenter extends BasePresenter implements UsersInteractorOutput {

    view: AddLearnerView
    private interactor: UsersInteractor

    constructor(outputView: AddLearnerView) {
        super(outputView)
