...
export interface BasicInfoView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class BasicInfoPresenter extends BasePresenter implements UsersInteractorOutput {

    view: BasicInfoView
    private interactor: UsersInteractor

    constructor(outputView: BasicInfoView) {
        super(outputView)
