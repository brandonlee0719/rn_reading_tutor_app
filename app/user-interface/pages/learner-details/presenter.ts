...
export interface LearnerDetailsView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class LearnerDetailsPresenter extends BasePresenter implements UsersInteractorOutput {

    view: LearnerDetailsView
    private interactor: UsersInteractor

    constructor(outputView: LearnerDetailsView) {
        super(outputView)
