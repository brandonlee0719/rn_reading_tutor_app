...
export interface LearnerGuideView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class LearnerGuidePresenter extends BasePresenter implements UsersInteractorOutput {

    view: LearnerGuideView
    private interactor: UsersInteractor

    constructor(outputView: LearnerGuideView) {
        super(outputView)
