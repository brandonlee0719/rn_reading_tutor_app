...
export interface ResetPasswordView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class ResetPasswordPresenter extends BasePresenter implements UsersInteractorOutput {

    view: ResetPasswordView
    private interactor: UsersInteractor

    constructor(outputView: ResetPasswordView) {
        super(outputView)
