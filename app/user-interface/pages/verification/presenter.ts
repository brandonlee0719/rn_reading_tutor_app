...
export interface VerificationView extends BaseView {
    goToHomeScreen(): void;
    goToWelcomeScreen?(): void;
    handleInvalidFields(invalidFields: Array<{field: Field, error: Error}>): void
}

export class VerificationPresenter extends BasePresenter implements UsersInteractorOutput {

    view: VerificationView
    private interactor: UsersInteractor

    constructor(outputView: VerificationView) {
        super(outputView)
