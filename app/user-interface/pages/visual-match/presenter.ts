...
export interface VisualMatchView extends BaseView {
    
}

export class VisualMatchPresenter extends BasePresenter implements LessonsInteractorOutput {

    view: VisualMatchView
    private interactor: LessonsInteractor

    constructor(outputView: VisualMatchView) {
        super(outputView)
