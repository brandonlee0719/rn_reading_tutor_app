...
import { WordBuilderPresenter, WordBuilderView } from './presenter'
...
export class WordBuilderScreen extends BaseScreen implements WordBuilderView {

    private presenter = new WordBuilderPresenter(this)
    ...
    showNextLessons() {
        this.props.navigation.navigate('WordBuilderLetterScreen')
    }
    showPreviousLessons() {
